...
function makeRequire(currentId){
	var require = function(id){
		...
		try{
			return moduleExports[id] || defaultRequire(id, "narwhal"); // for narwhal, only look for narwhal system modules, this will be ignored by node
		}catch(e){
	...
	var ensure = require.ensure = function(id, callback){
		...
		function onError(error){
			...
			try{
				...
				moduleExports[id] || defaultRequire(id, "narwhal");
			}catch(e){
